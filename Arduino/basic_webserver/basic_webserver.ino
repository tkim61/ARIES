/*
Use the Wire-WireScan example to look for I2C connected chips (i.e. the mpu6050)
Change the MPU_addr to that value
*/
...
// WiFi network info.
const char *ssid =  "RLAB";     // Enter your WiFi Name
const char *pass =  "metropolis"; // Enter your WiFi Password
      ...
      {                
        char c = client.read();                // read a byte
          ...
          {  
            ...
            doc["Head"] = !head;
            serializeJson(doc, response, 144);
